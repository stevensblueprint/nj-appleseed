export default function ResourcesAndTools(title, comp) {
  return (
    <>
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <h2 className="text-4xl font-light text-[#8A9A5B] mb-6">Websites</h2>
        <article className="mb-8">state websites having to do with charity care</article>
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <h2 className="text-4xl font-light text-[#8A9A5B] mb-6">Federal Poverty Level</h2>
        <article className="mb-8">information regarding federal poverty level</article>
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <h2 className="text-4xl font-light text-[#8A9A5B] mb-6">Key Statutes</h2>
        <article className="mb-8">states key statutes</article>
